...
const AvailableQuestions = ({ courseId, onAddQuestion }) => {
  ...
  const [selectedQuestion, setSelectedQuestion] = useState(null); // Lưu toàn bộ câu hỏi đã chọn
    ...
    <div className="form-group">
      ...
      <Select
        ...
        onChange={(option) => {
          ...
          console.log("Selected Question:", question); // Log toàn bộ câu hỏi
          setSelectedQuestion(question); // Lưu toàn bộ câu hỏi
        }}
